<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
        <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="TalentMapping Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">TalentMapping</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ request()->routeIs('admin.questions.*') || request()->routeIs('admin.st30.*') || request()->routeIs('admin.sjt.*') || request()->routeIs('admin.competencies.*') || request()->routeIs('admin.typologies.*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.st30.index') }}" class="nav-link {{ request()->routeIs('admin.st30.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>ST-30 Questions</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.sjt.index') }}" class="nav-link {{ request()->routeIs('admin.sjt.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>SJT Questions</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.competencies.index') }}" class="nav-link {{ request()->routeIs('admin.competencies.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Competencies</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.typologies.index') }}" class="nav-link {{ request()->routeIs('admin.typologies.*') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Typologies</p>
                            </a>
                        </li>
