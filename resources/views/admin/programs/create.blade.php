...
<div class="form-card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <h1 style="font-size: 1.5rem; font-weight: 800; color: #0f172a; display: flex; align-items: center; gap: 10px;">
            <i class="fas fa-plus-circle text-green-500 bg-green-100 p-2 rounded-xl"></i>
            Buat Program Baru
        </h1>
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 3rem;">
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode_program" id="kode_program" class="form-control font-mono font-bold" value="{{ old('kode_program') }}" placeholder="CONTOH: BCTI2026" required>
                ...
                <div class="form-group">
                    ...
                    <select name="id_mitra" class="form-control" required>
                        ...
                        @foreach($mitras as $m) <option value="{{ $m->id }}">{{ $m->nama }} ({{ $m->email }})</option> @endforeach
                    </select>
                </div>
                <div class="form-group">
            ...
            <div>
                <div class="form-section-title"><i class="fas fa-cog text-green-500"></i> Pengaturan & Jadwal</div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="maks_peserta" class="form-control" value="{{ old('maks_peserta') }}" placeholder="Kosongkan jika bebas" min="1">
                </div>
                <div class="form-group mt-6">
                    <label class="form-label">Status Program</label>
                    <div class="toggle-wrapper">
                        <label class="switch"><input type="checkbox" name="aktif" value="1" {{ old('aktif', 1) ? 'checked' : '' }}><span class="slider"></span></label>
                        <div>
                            <span style="font-weight: 600; display:block;">Aktifkan Publikasi</span>
                            <span style="font-size: 0.75rem; color:#64748b;">Peserta bisa mendaftar.</span>
                        </div>
                    </div>
                </div>
            </div>
