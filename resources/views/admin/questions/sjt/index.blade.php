                                ...
                                <tbody>
                                    @foreach ($questions as $question)
                                        <tr data-question-id="{{ $question->id }}">
                                            ...
                                            <td>
                                                <span class="competency-tag">
                                                    {{ $question->competency_code }}
                                                </span>
                                                <br>
                                                <small
                                                    class="text-muted">{{ Str::limit($question->competency_name, 25) }}</small>
                                            </td>
                                            <td>
                                                <span class="badge badge-info">{{ $question->options->count() }}/5</span>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-{{ $question->is_active ? 'success' : 'secondary' }}">
                                                ...
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    @if (Auth::user()->role === 'admin')
                                                        ...
                                                        @if ($question->usage_count === 0)
                                                            <form action="{{ route('admin.sjt.destroy', $question) }}"
