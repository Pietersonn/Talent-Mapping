        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-overlay">
                    ...
                    <p>Isi data diri Anda untuk memulai tes dan temukan potensi serta kekuatan yang akan membantu Anda merencanakan karier yang lebih tepat.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-section">
        <div class="container">
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('test.form.store') }}" class="test-form">
                    @csrf
                        ...
                        <div class="form-column">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('workplace') }}"
                                       required
                                       placeholder="Sekolah/Unit Kerja/Universitas"
                                       class="form-input">
                                @error('workplace')
                                    <span class="error-text">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn btn-submit" id="submitBtn" disabled>Kirim & Lanjutkan</button>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateEventCode() {
        ...
        if (inputCode === correctCode) {
            codeValidation.innerHTML = '<span class="validation-success"><i class="icon-check"></i> Kode event benar</span>';
            validateForm();
        } else {
            codeValidation.innerHTML = '<span class="validation-error"><i class="icon-times"></i> Kode event tidak sesuai</span>';
            submitBtn.disabled = true;
        }
    }
